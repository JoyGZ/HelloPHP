...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query="delete from gzphpdb.James_Info where jid=$jid ";
        //query DB
        ...
        <div style="width: 95%;">
            <div class="alert alert-success" role="alert">
                <strong>Well done!</strong> You successfully delete this data from DB.
            </div>
        </div>
        <?php
            ...
            <form method="post" action="RemoveJamesInfo.php">
                ...
                <div class="form-row">
                    <div class="my-center-form" style="margin: 0 auto">
                        <input class="btn btn-primary" type="submit" value="Delete Data" name="submit">
                    </div>
                </div>
            </form>
            <?php
